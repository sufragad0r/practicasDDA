...
public class MainActivity extends AppCompatActivity {
    ...
    private void startScoreActivity() {
        ...
        intent.putExtra(ScoreActivity.LOCAL_SCORE_KEY,
                viewModel.getLocalScore().getValue());
        intent.putExtra(ScoreActivity.VISITOR_SCORE_KEY,
                viewModel.getVisitorScore().getValue());
